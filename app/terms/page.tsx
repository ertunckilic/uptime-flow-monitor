export default function TermsPage() {
    return (
      <div className="max-w-4xl mx-auto py-20 px-6 text-gray-300">
        <h1 className="text-4xl font-bold mb-8 text-white">Kullanım Koşulları</h1>
        <p className="mb-6">UptimeFlow platformuna hoş geldin. Bu siteyi kullanarak aşağıdaki şartları kabul etmiş sayılırsın.</p>
        
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-white">1. Hizmet Tanımı</h2>
        ...
        <p className="mt-12 text-sm">Son güncellenme: 15 Nisan 2026</p>
      </div>
    );
  }